...
// create a 360 image
const image360 = new Sky('assets/images/sampleImage.jpg');
...
cuberoom.setPosition(-3.5, 1, 1);
cuberoom.setScale(0.1, 1, 0.1);
cuberoom.setRotation(0, -37, 0);